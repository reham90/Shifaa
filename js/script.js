...
$(document).ready(function() {
  ...
  $(".more").click(function(e) {
    e.preventDefault();
    var html = '  <div class="form-record"> <div class="form-block"> <label class="form-label"> اسم الصنف</label><input type="text" class="form-input"></div><div class="form-block"><label class="form-label">الكمية المطلوبة</label><input type="text" class="form-input"></div></div>';
    $('.forget-block').append(html);
  });

  $(".more-2").click(function(e) {
    e.preventDefault();
    var html = '  <label class="form-label"> رقم الموبايل </label><input type="tel" class="form-input"> <button class="send-btn">إرسال للإدارة</button> ';
    $('.forget-block').append(html);
  });
